            ...
            <>
                <div>
                    ...
                    <TextField
                        ...
                        onChange={(e) => this.props.onChange({ machineWidth: parseInt(e.target.value) })}
                        type="number"
                    />
                    <TextField
                        ...
                        onChange={(e) => this.props.onChange({ machineHeight: parseInt(e.target.value) })}
                        type="number"
                    />
                    <TextField
                        label="machine speed"
                        ...
                        onChange={(e) => this.props.onChange({ machineSpeed: parseFloat(e.target.value) })}
                        type="number"
                    />
                </div>
                <div>
                    ...
                    <TextField
                        ...
                        onChange={(e) => this.props.onChange({ rowLength: parseInt(e.target.value) })}
                        type="number"
                    />
                    <TextField
                        label="machine space"
                        ...
                        onChange={(e) => this.props.onChange({ machineSpace: parseInt(e.target.value) })}
                        type="number"
                    />
                    <TextField
                        label="row space"
                        ...
                        onChange={(e) => this.props.onChange({ rowSpace: parseInt(e.target.value) })}
                        type="number"
                    />
                </div>
                <div>
                    ...
                    <TextField
                        ...
                        onChange={(e) => this.props.onChange({ sourceChestWidth: parseInt(e.target.value) })}
                        type="number"
                    />
                    <TextField
                        ...
                        onChange={(e) => this.props.onChange({ sourceChestHeight: parseInt(e.target.value) })}
                        type="number"
                    />
                    <FormControlLabel
                        control={
                            <Checkbox
                                checked={this.props.settings.requestFromBuffers}
                            />
                        }
                ...
                <div>
                    ...
                    <TextField
                        ...
                        onChange={(e) => this.props.onChange({ targetChestWidth: parseInt(e.target.value) })}
                        type="number"
                    />
                    <TextField
                        ...
                        onChange={(e) => this.props.onChange({ targetChestHeight: parseInt(e.target.value) })}
                        type="number"
                    />
                    <FormControlLabel
                        control={
                            <Checkbox
                                checked={this.props.settings.targetChestSetRequest}
                            />
                        }
